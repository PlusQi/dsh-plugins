window.__ModuleLoader__.load({
	...
	function TokstatsButton({ wide, useSessions, t }) {
		...
		const promptoptCss = [
			...
			".dsh-promptopt-trigger{color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:8px;align-items:center;justify-content:center;padding:0;width:28px;height:28px;font:inherit;font-size:12px;display:inline-flex}",
